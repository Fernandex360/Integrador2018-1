...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light m-0 p-0">
      ...
      <div class="collapse navbar-collapse mr-3" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" method="POST" action="{{route('principal.store')}}">
            {{ csrf_field() }}
          <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="busqueda" id="busqueda">
